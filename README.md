...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cyclonedx-python-lib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cyclonedx-python-lib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cyclonedx-python-lib cyclonedx-python-lib-with-json-validation cyclonedx-python-lib-with-validation cyclonedx-python-lib-with-xml-validation
# for installing globally
pixi global install cyclonedx-python-lib cyclonedx-python-lib-with-json-validation cyclonedx-python-lib-with-validation cyclonedx-python-lib-with-xml-validation
```
...
It is possible to list all of the versions of `cyclonedx-python-lib` available on your platform:
...
```
pixi search cyclonedx-python-lib --channel conda-forge
```
