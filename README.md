...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cyclonedx-python-lib-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `cyclonedx-python-lib` can be installed with:

```
conda install cyclonedx-python-lib
```

It is possible to list all of the versions of `cyclonedx-python-lib` available on your platform with:
